...
</div><?php $link_ContainerID = 'btTwoColumnFeaturesBlock-link-container-' . $identifier_getString; ?>
...
<script type="text/javascript">
	Concrete.event.publish('btTwoColumnFeaturesBlock.link.open', {id: '<?php echo $link_ContainerID; ?>'});
...
<?php $repeatable_container_id = 'btTwoColumnFeaturesBlock-features-container-' . $identifier_getString; ?>
    ...
    <textarea name="<?php echo $view->field('features'); ?>[{{id}}][featureDescription]" id="<?php echo $view->field('features'); ?>[{{id}}][featureDescription]" class="form-control" rows="5">{{ featureDescription }}</textarea>
</div></div>
...
<script type="text/javascript">
    Concrete.event.publish('btTwoColumnFeaturesBlock.features.edit.open', {id: '<?php echo $repeatable_container_id; ?>'});
