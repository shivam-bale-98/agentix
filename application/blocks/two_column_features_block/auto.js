Concrete.event.bind('btTwoColumnFeaturesBlock.link.open', function (options, settings) {
...
});Concrete.event.bind('btTwoColumnFeaturesBlock.features.edit.open', function (options, settings) {
    var container = $('#' + settings.id);
