Concrete.event.bind('btContactFormBlock.categories.edit.open', function (options, settings) {
...
});Concrete.event.bind('contact_form_block.form.stacks', function () {
    $(document).ready(function () {
        $('select[name="form[]"]').select2_sortable();
    });
});