            ...
            <form action="<?php echo \URL::to('/formidable/dialog/formidable'); ?>" method="post" class="needs-validation" novalidate enctype="multipart/form-data" data-form-handle="formidable_<?= $ff->getHandle(); ?>">
                ...
                <?php if (!$ff->hasSubmitButton()) { ?>
                    <div class="row mt-2 x:mt-[4rem]">
                        <div class="col-12">
                            <!-- <button  class="  channeline-btn channeline-btn--arrow channeline-btn--border channeline-btn--white relative">
                            ...
                            <div class="tp-contact-form-btn">
                                <button id="<?php echo 'btnSubmit_' . $ff->getItemID(); ?>" name="<?php echo 'btnSubmit_' . $ff->getItemID(); ?>" type="submit" class="w-100 btn btn-primary" type="submit"><span>
