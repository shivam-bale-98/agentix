Concrete.event.bind('btCareersSlider.slider.edit.open', function (options, settings) {
    ...
    var ftImageImage = $(newField).find('.ft-image-slider-image-file-selector');
            ...
            var pageSelectorImage = $(newField).find('.ft-image-slider-image-page-selector');
