...
(function ($) {
  ...
  // 33. addClass removeClass //
  $(
    ".des-text-moving-wrap .des-text-moving-top, .des-team-wrap .des-team-item-box"
  ).on("mouseenter", function () {
  ...
  $(".design-award-wrap .design-award-item")
    .on("mouseenter", function () {
      $(this)
        .addClass("active")
        .parent()
        .siblings()
        .find(".design-award-item")
        .removeClass("active");
    })
    .on("mouseleave", function () {
      $(this)
    ...
    pw.add("(min-width: 1200px)", () => {
      document.querySelectorAll(".design-work-wrapper").forEach((item) => {
        ...
        tl.to(item.querySelector(".design-work-item-1"), {
          ...
          item.querySelector(".design-work-item-2"),
          { x: 400, rotate: 40 },
          0
        );
      });
  ...
  if ($("#lineMarker").length > 0) {
    function tp_tab_bg() {
      ...
      let itemActive = document.querySelector(
        ".tp-marker-tab ul li .nav-links.active"
      );
