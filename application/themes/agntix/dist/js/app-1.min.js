...
var ListingBlock = /*#__PURE__*/_createClass(function ListingBlock() {
  ...
  _defineProperty(this, "formParams", function () {
    var _this$keywords$val;
    var data = {};
    data["keywords"] = (_this$keywords$val = _this.keywords.val()) !== null && _this$keywords$val !== void 0 ? _this$keywords$val : "";
...
var blurredImg = $(".blurred-img");
var phoneInput = $("input[type='tel']");
var selectField = $(".js-filter--section .select-box select");
...
var map = {
	...
	"./Select2": [
		"./src/js/components/Select2.js",
		"vendors-node_modules_gsap_index_js-node_modules_select2_dist_css_select2_css-node_modules_sel-2873cc",
		"Select2"
	],
	"./Select2.js": [
		"./src/js/components/Select2.js",
...
/******/ 			var cssChunks = {"vendors-node_modules_intl-tel-input_build_js_intlTelInput_js-node_modules_intl-tel-input_buil-3a9639":1,"vendors-node_modules_gsap_index_js-node_modules_select2_dist_css_select2_css-node_modules_sel-2873cc":1};
  ...
  function App() {
    ...
    _defineProperty(this, "captchaLoad", function () {
      $(window).on("scroll load", function () {
        if ((0,_utils__WEBPACK_IMPORTED_MODULE_4__.inVP)(_this.formidable) && !_this.formidable.hasClass("formInview")) {
    ...
    _defineProperty(this, "windowScroll", function () {
      ...
      _this.header.toggleClass("top", topOffset > 80);
      _this.header.toggleClass("sticky-header", topOffset > 300);
      if (topOffset > _this.previousScroll || topOffset < 400) {
        _this.header.removeClass("sticky-header");
      } else if (topOffset < _this.previousScroll) {
        _this.header.addClass("sticky-header");
