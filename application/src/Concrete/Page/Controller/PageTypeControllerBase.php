...
class PageTypeControllerBase extends PageController
{
    ...
    public function sendResult($result = [])
    {
        ...
        if ($this->hasErrors()) {
            $ajax->sendResult(array_merge(['success' => false, 'error_code' => $this->getErrorCode(), 'message' => $this->getErrors(), 'display_error_message' => $this->getErrorHelper()->__toString()], $result));
            die();
        }
        ...
        $this->getAjaxHelper()->sendResult($result);
        die();
    }
