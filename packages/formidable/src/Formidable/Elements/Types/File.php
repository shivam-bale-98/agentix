    ...
    public function field()
    {
        ...
        switch ($view) {
            ...
            case 'dropzone':
                ...
                if($this->element->getProperty('extensions_value','string')){
                    $extensions = $this->element->getProperty('extensions_value','string');
                    $extensions = array_map(function($ext) { return '.'.$ext; }, explode(',', $extensions));
                    $extensionString = $this->element->getProperty('extensions_value','string');
                }else{
                    $extensions = $this->getAllowedExtensions();
                    $extensions = array_map(function($ext) { return '.'.$ext; }, $extensions);
                    $extensionString = 'PDF,doc,jpeg';
                }
                ...
                $input .= t('%s format. Max %s mb size',strtoupper($extensionString),$filesize);
                $input .= '</div>';
